export default {
    ...
    contribute: {
        ...
        "report_bad_sentences": "Данные предложения автоматически загружены из публичной базы данных. Пожалуйста, сообщайте о любых неуместных или неправильных предложениях.",
    },
    edit_translations: {
