export default {
    ...
    commonVoiceCTA: {
        "bannerTitle": "Çerkesçe konuşmayı dijital çağda korumaya yardım edin",
        "bannerCta": "Daha fazlası",
        "bannerAriaLabel": "Mozilla Common Voice projesi ayrıntılarını aç",
        "modalTitle": "Mozilla Common Voice · Circassian",
        "paragraph1": "Çerkesçe ses kayıtları toplamak için yürütülen uluslararası <b>Mozilla Common Voice</b> projesine katılın.",
        "paragraph2": "Bu veriler geliştiricilerin ve büyük teknoloji şirketlerinin konuşma tanıma, ses sentezi, makine çevirisi ve dilimizle ilgili diğer teknolojileri geliştirmesine yardımcı olur.",
        "paragraph3": "Her yaştan, cinsiyetten, ülkeden, aksandan ve lehçeden ana dili Çerkesçe olan konuşmacıların seslerine ihtiyacımız var. Çeşitlilik arttıkça teknolojiler Çerkesçeyi daha iyi anlayacak.",
        "paragraph4": "Katılmak için ekranda görünen kısa cümleleri yüksek sesle okumanız yeterli. Günde sadece birkaç dakikanızı alır.",
        "telegramButtonTitle": "Projeye Telegram'da katılın",
        "telegramAriaLabel": "Telegram davetini aç",
        "close": "Kapat",
    },
    validate: {
