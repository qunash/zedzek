...
export default function SentenceTranslator({
  ...
  const handleSubmit = () => {
    ...
    setHistory((prev) => [
      ...prev,
      { index: currentIndex, action: "submit", translation: userTranslation },
    ])
    setUserTranslation("")
    focusOnTextarea()
  }
  ...
  const handleSkip = () => {
    setHistory((prev) => [
      ...prev,
      { index: currentIndex, action: "skip", translation: userTranslation },
    ])
    setUserTranslation("")
    focusOnTextarea()
  }
  ...
  return (
    <div className="flex w-full flex-col items-center gap-10">
      <div className="flex items-center gap-4">
        <h2 className="text-2xl font-semibold">Translate the following text</h2>
      ...
      >
        <HoverButton icon={Icons.skip} text="Skip" onClick={handleSkip} />
        <HoverButton
          icon={Icons.submit}
          text="Submit"
        ...
        />
        {history.length > 0 ? (
          <HoverButton icon={Icons.undo} text="Undo" onClick={handleUndo} />
        ) : (
          <div className="p-10" />
        )}
      </div>
