...
export default function Examples(
    ...
    const examples = [
        ...
        ["А ешхэ-ешъом къыхэкӀыкӀэ унэшъо пытэ зэдашӀи, мэзищ пӀалъэу кӀалэм ратыгъ. Ащ нэс кӀалэм зиухьазырынышъ, мэзищ зыхъукӀэ ежьэнышъ хыгъунэм кӀонэу, адрэхэри ащ къекӀолӀэнхэу. Хыр зыришъукӀэ ямылъкухэр къыратынхэу, зыримышъукӀэ кӀалэм имылъку аритынэу зэзэгъыхи зэбгъодэкӀыжьыгъэх.", "ru"],
        ["أين تعيش؟", "kbd"],
        ["Πού ζεις;", "ady"],
        ["שלום, מה שלומך?", "kbd"],
